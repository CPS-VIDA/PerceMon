...
TEST_CASE("Euclidean distance", "[datastream][distance]") {
    auto bbox1 = BoundingBox{0, 10, 0, 10};
    auto bbox2 = BoundingBox{30, 40, 0, 10};

    auto dist = euclidean_distance(
        bbox1, RefPointType::Center,
        bbox2, RefPointType::Center
    );
...
TEST_CASE("Euclidean distance with different reference points", "[datastream][distance]") {
    auto bbox1 = BoundingBox{0, 10, 0, 10};
    auto bbox2 = BoundingBox{10, 20, 0, 10};

    SECTION("Right margin of bbox1 to left margin of bbox2") {
        auto dist = euclidean_distance(
            bbox1, RefPointType::RightMargin,
            bbox2, RefPointType::LeftMargin
        );
        // (10, 5) to (10, 5) = 0
        REQUIRE(dist == 0.0);
    }
...
TEST_CASE("Frame with multiple objects", "[datastream][frame][object]") {
    auto frame = Frame{
        ...
        .size_y = 1080,
        .objects = {
            {"car_1", Object{1, 0.95, BoundingBox{100, 200, 50, 150}}},
            {"pedestrian_1", Object{2, 0.85, BoundingBox{500, 550, 300, 600}}}
        }
    };
...
TEST_CASE("BoundingBox comparison", "[datastream][bbox][comparison]") {
    auto bbox1 = BoundingBox{100, 200, 50, 150};
    auto bbox2 = BoundingBox{100, 200, 50, 150};
    auto bbox3 = BoundingBox{100, 200, 50, 151};
...
TEST_CASE("Object comparison", "[datastream][object][comparison]") {
    ...
    auto obj1 = Object{1, 0.95, bbox1};
    auto obj2 = Object{1, 0.95, bbox2};
    auto obj3 = Object{2, 0.95, bbox1};
